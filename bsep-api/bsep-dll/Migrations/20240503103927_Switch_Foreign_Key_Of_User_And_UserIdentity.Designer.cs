...
namespace bsep_dll.Migrations
{
    ...
    [Migration("20240503103927_Switch_Foreign_Key_Of_User_And_UserIdentity")]
    partial class Switch_Foreign_Key_Of_User_And_UserIdentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("bsep_dll.Models.User", b =>
                {
                    b.HasOne("bsep_dll.Models.UserIdentity", "UserIdentity")
                        .WithOne("User")
                        .HasForeignKey("bsep_dll.Models.User", "UserIdentityEmail")
